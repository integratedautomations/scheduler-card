...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
var b;f[y]=!0,f.elementProperties=new Map,f.elementStyles=[],f.shadowRootOptions={mode:"open"},null==p||p({ReactiveElement:f}),(null!==(c=u.reactiveElementVersions)&&void 0!==c?c:u.reactiveElementVersions=[]).push("1.6.3");const w=window,k=w.trustedTypes,x=k?k.createPolicy("lit-html",{createHTML:e=>e}):void 0,$=`lit$${(Math.random()+"").slice(9)}$`,j="?"+$,O=`<${j}>`,S=document,C=()=>S.createComment(""),z=e=>null===e||"object"!=typeof e&&"function"!=typeof e,A=Array.isArray,E="[ \t\n\f\r]",T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,D=/-->/g,M=/>/g,L=RegExp(`>|${E}(?:([^\\s"'>=/]+)(${E}*=${E}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),P=/'/g,N=/"/g,I=/^(?:script|style|textarea|title)$/i,q=(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}))(1),R=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),H=new WeakMap,F=S.createTreeWalker(S,129,null,!1);function U(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==x?x.createHTML(t):t}const B=(e,t)=>{const i=e.length-1,s=[];let a,o=2===t?"<svg>":"",n=T;for(let t=0;t<i;t++){const i=e[t];let r,d,l=-1,c=0;for(;c<i.length&&(n.lastIndex=c,d=n.exec(i),null!==d);)c=n.lastIndex,n===T?"!--"===d[1]?n=D:void 0!==d[1]?n=M:void 0!==d[2]?(I.test(d[2])&&(a=RegExp("</"+d[2],"g")),n=L):void 0!==d[3]&&(n=L):n===L?">"===d[0]?(n=null!=a?a:T,l=-1):void 0===d[1]?l=-2:(l=n.lastIndex-d[2].length,r=d[1],n=void 0===d[3]?L:'"'===d[3]?N:P):n===N||n===P?n=L:n===D||n===M?n=T:(n=L,a=void 0);const u=n===L&&e[t+1].startsWith("/>")?" ":"";o+=n===T?i+O:l>=0?(s.push(r),i.slice(0,l)+"$lit$"+i.slice(l)+$+u):i+$+(-2===l?(s.push(void 0),t):u)}return[U(e,o+(e[i]||"<?>")+(2===t?"</svg>":"")),s]};class W{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let a=0,o=0;const n=e.length-1,r=this.parts,[d,l]=B(e,t);if(this.el=W.createElement(d,i),F.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(s=F.nextNode())&&r.length<n;){if(1===s.nodeType){if(s.hasAttributes()){const e=[];for(const t of s.getAttributeNames())if(t.endsWith("$lit$")||t.startsWith($)){const i=l[o++];if(e.push(t),void 0!==i){const e=s.getAttribute(i.toLowerCase()+"$lit$").split($),t=/([.?@])?(.*)/.exec(i);r.push({type:1,index:a,name:t[2],strings:e,ctor:"."===t[1]?Y:"?"===t[1]?X:"@"===t[1]?ee:G})}else r.push({type:6,index:a})}for(const t of e)s.removeAttribute(t)}if(I.test(s.tagName)){const e=s.textContent.split($),t=e.length-1;if(t>0){s.textContent=k?k.emptyScript:"";for(let i=0;i<t;i++)s.append(e[i],C()),F.nextNode(),r.push({type:2,index:++a});s.append(e[t],C())}}}else if(8===s.nodeType)if(s.data===j)r.push({type:2,index:a});else{let e=-1;for(;-1!==(e=s.data.indexOf($,e+1));)r.push({type:7,index:a}),e+=$.length-1}a++}}static createElement(e,t){const i=S.createElement("template");return i.innerHTML=e,i}}function Z(e,t,i=e,s){var a,o,n,r;if(t===R)return t;let d=void 0!==s?null===(a=i._$Co)||void 0===a?void 0:a[s]:i._$Cl;const l=z(t)?void 0:t._$litDirective$;return(null==d?void 0:d.constructor)!==l&&(null===(o=null==d?void 0:d._$AO)||void 0===o||o.call(d,!1),void 0===l?d=void 0:(d=new l(e),d._$AT(e,i,s)),void 0!==s?(null!==(n=(r=i)._$Co)&&void 0!==n?n:r._$Co=[])[s]=d:i._$Cl=d),void 0!==d&&(t=Z(e,d._$AS(e,t.values),d,s)),t}class K{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:s}=this._$AD,a=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:S).importNode(i,!0);F.currentNode=a;let o=F.nextNode(),n=0,r=0,d=s[0];for(;void 0!==d;){if(n===d.index){let t;2===d.type?t=new J(o,o.nextSibling,this,e):1===d.type?t=new d.ctor(o,d.name,d.strings,this,e):6===d.type&&(t=new te(o,this,e)),this._$AV.push(t),d=s[++r]}n!==(null==d?void 0:d.index)&&(o=F.nextNode(),n++)}return F.currentNode=S,a}v(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class J{constructor(e,t,i,s){var a;this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cp=null===(a=null==s?void 0:s.isConnected)||void 0===a||a}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===(null==e?void 0:e.nodeType)&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Z(this,e,t),z(e)?e===V||null==e||""===e?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==R&&this._(e):void 0!==e._$litType$?this.g(e):void 0!==e.nodeType?this.$(e):(e=>A(e)||"function"==typeof(null==e?void 0:e[Symbol.iterator]))(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==V&&z(this._$AH)?this._$AA.nextSibling.data=e:this.$(S.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:s}=e,a="number"==typeof s?this._$AC(e):(void 0===s.el&&(s.el=W.createElement(U(s.h,s.h[0]),this.options)),s);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===a)this._$AH.v(i);else{const e=new K(a,this),t=e.u(this.options);e.v(i),this.$(t),this._$AH=e}}_$AC(e){let t=H.get(e.strings);return void 0===t&&H.set(e.strings,t=new W(e)),t}T(e){A(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const a of e)s===t.length?t.push(i=new J(this.k(C()),this.k(C()),this,this.options)):i=t[s],i._$AI(a),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$Cp=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class G{constructor(e,t,i,s,a){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=a,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=V}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,s){const a=this.strings;let o=!1;if(void 0===a)e=Z(this,e,t,0),o=!z(e)||e!==this._$AH&&e!==R,o&&(this._$AH=e);else{const s=e;let n,r;for(e=a[0],n=0;n<a.length-1;n++)r=Z(this,s[i+n],t,n),r===R&&(r=this._$AH[n]),o||(o=!z(r)||r!==this._$AH[n]),r===V?e=V:e!==V&&(e+=(null!=r?r:"")+a[n+1]),this._$AH[n]=r}o&&!s&&this.j(e)}j(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class Y extends G{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===V?void 0:e}}const Q=k?k.emptyScript:"";class X extends G{constructor(){super(...arguments),this.type=4}j(e){e&&e!==V?this.element.setAttribute(this.name,Q):this.element.removeAttribute(this.name)}}class ee extends G{constructor(e,t,i,s,a){super(e,t,i,s,a),this.type=5}_$AI(e,t=this){var i;if((e=null!==(i=Z(this,e,t,0))&&void 0!==i?i:V)===R)return;const s=this._$AH,a=e===V&&s!==V||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==V&&(s===V||a);a&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==i?i:this.element,e):this._$AH.handleEvent(e)}}class te{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Z(this,e)}}const ie=w.litHtmlPolyfillSupport;null==ie||ie(W,J),(null!==(b=w.litHtmlVersions)&&void 0!==b?b:w.litHtmlVersions=[]).push("2.8.0");
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
var se,ae;class oe extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return null!==(e=(t=this.renderOptions).renderBefore)&&void 0!==e||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,i)=>{var s,a;const o=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:t;let n=o._$litPart$;if(void 0===n){const e=null!==(a=null==i?void 0:i.renderBefore)&&void 0!==a?a:null;o._$litPart$=n=new J(t.insertBefore(C(),e),e,void 0,null!=i?i:{})}return n._$AI(e),n})(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!1)}render(){return R}}oe.finalized=!0,oe._$litElement$=!0,null===(se=globalThis.litElementHydrateSupport)||void 0===se||se.call(globalThis,{LitElement:oe});const ne=globalThis.litElementPolyfillSupport;null==ne||ne({LitElement:oe}),(null!==(ae=globalThis.litElementVersions)&&void 0!==ae?ae:globalThis.litElementVersions=[]).push("3.3.3");const re=async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-generic-picker")&&customElements.get("ha-selector"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");if(await t.routerOptions.routes.automation.load(),!customElements.get("ha-selector")&&window.loadCardHelpers)try{const e=await window.loadCardHelpers(),t=await e.createCardElement({type:"entities",entities:[]});t&&t.constructor&&t.constructor.getConfigElement&&await t.constructor.getConfigElement()}catch(e){}},de=e=>t=>"function"==typeof t?((e,t)=>(customElements.define(e,t),t))(e,t):((e,t)=>{const{kind:i,elements:s}=t;return{kind:i,elements:s,finisher(t){customElements.define(e,t)}}})(e,t)
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
/**
        ...
        <div slot="header">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              data-dialog="close"
              .label=${ms("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${sa}
            ></ha-icon-button>
            <div slot="title">
              ${ls("ui.dialog.entity_picker.title",this.hass)}
            </div>
          </ha-dialog-header>

          <ha-input
            dialogInitialFocus
            .placeholder=${ms("ui.common.search",this.hass)}
            aria-label=${ms("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&q`
                <ha-icon-button
                  ...
                  .label=${ms("ui.common.clear",this.hass)}
                  .path=${sa}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:q``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("ha-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e,t){var i;let s=e.target;for(;"HA-LIST-ITEM"!=s.tagName;)s=s.parentElement;const a=s.getAttribute("key"),o=null===(i=this.options)||void 0===i?void 0:i.find(e=>e.key==a).entities.map(e=>e.key);this._params=t?Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==o?void 0:o.includes(e)))}):Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("ha-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"HA-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>va(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>va(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const d=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length,l=(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)});return q`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${ms(l?"ui.components.media-browser.file_management.deselect_all":"ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${ta}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
          <span slot="secondary">${ls("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[d,r.length])}</span>
        </ha-list-item>
      ...
      `}):q`
        <ha-list-item disabled>
          ${ms("ui.components.entity.entity-picker.no_match",this.hass)}
        </ha-list-item>
    ...
    `}};t([ce({attribute:!1})],ya.prototype,"hass",void 0),t([ue()],ya.prototype,"_params",void 0),t([ue()],ya.prototype,"_search",void 0),t([ue()],ya.prototype,"_filter",void 0),t([ue()],ya.prototype,"_width",void 0),t([ue()],ya.prototype,"_height",void 0),t([ue()],ya.prototype,"expandedGroups",void 0),t([ue()],ya.prototype,"options",void 0),t([ue()],ya.prototype,"scheduleEntities",void 0),ya=t([de("dialog-select-entities")],ya);var fa=Object.freeze({__proto__:null,get DialogSelectEntities(){return ya}});let ba=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return V;if(this.toggleable)return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?V:q`<ha-tooltip for="${e}">${ms("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
    ...
    `}};t([ce({attribute:!1})],ba.prototype,"hass",void 0),t([ce({type:String})],ba.prototype,"icon",void 0),t([ce({type:Boolean})],ba.prototype,"useStateIcon",void 0),t([ce({type:Boolean})],ba.prototype,"selectable",void 0),t([ce({type:Boolean})],ba.prototype,"removable",void 0),t([ce({type:Boolean})],ba.prototype,"toggleable",void 0),t([ce({type:Boolean})],ba.prototype,"active",void 0),t([ce({type:String})],ba.prototype,"badge",void 0),t([ce({type:String})],ba.prototype,"value",void 0),t([ce({type:Boolean})],ba.prototype,"disabled",void 0),ba=t([de("scheduler-chip")],ba);let wa=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([ce({attribute:!1})],wa.prototype,"hass",void 0),t([ce({attribute:!1})],wa.prototype,"items",void 0),t([ce({attribute:!1})],wa.prototype,"value",void 0),t([ce({type:Boolean})],wa.prototype,"selectable",void 0),t([ce({type:Boolean})],wa.prototype,"toggleable",void 0),t([ce({type:Boolean})],wa.prototype,"removable",void 0),t([ce({type:Boolean})],wa.prototype,"disabled",void 0),wa=t([de("scheduler-chip-set")],wa);const ka=[{name:"primary",weight:10},{name:"secondary",weight:8}];let xa=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${oa}
          style="margin: 0 4px"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Ae(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||je).some(t=>Te(t,e))||Object.keys(this.config.customize||{}).some(t=>Te(t,e)))&&!(this.config.exclude||[]).some(t=>Te(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e]))),e.map(e=>this._parseEntityItem(e))}}async firstUpdated(){this.scheduleEntities=Object.entries(await Ze(this.hass)).map(([,e])=>e.entity_id),this.domain&&this.config&&!De(this.domain,this.config)&&(this.config=Object.assign(Object.assign({},this.config),{include:[...this.config.include||[],this.domain],exclude:[...(this.config.exclude||[]).filter(e=>!e.startsWith(this.domain))]})),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],Qs(this,"value-changed",{value:this.value}))}render(){var e,t;return q`
      ${this.renderChips()}

      ${(null===(e=this.value)||void 0===e?void 0:e.length)&&!this.multipleMode&&this.multiple?V:q`

      <ha-generic-picker
        .label=${(null===(t=this.value)||void 0===t?void 0:t.length)?"":ms("ui.components.entity.entity-picker.choose_entity",this.hass)}
        .hass=${this.hass}
        .autofocus=${this.autofocus}
        .notFoundLabel=${ms("ui.components.combo-box.no_match",this.hass)}
        ...
        .searchKeys=${ka}
        .searchLabel=${ms("ui.dialogs.quick-bar.filter_placeholder",this.hass)}
    ...
    `}renderChips(){if(!this.multiple)return V;let e=(this.value||[]).map(e=>{const t=this._parseEntityItem(e);return{name:t.primary,value:e,useStateIcon:!t.icon,icon:t.icon}});return q`
      ...
      <ha-icon-button
        ...
        .path=${this.multipleMode?"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z":ta}
        slot="end"
      ></ha-icon-button>
      `:V}
      </div>
      </div>
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),Qs(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),Qs(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,s,a;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>Te(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(s=o.find(e=>"icon"in e))||void 0===s?void 0:s.icon;return{id:e,primary:n||Ee(e,null===(a=this.hass.states[e])||void 0===a?void 0:a.attributes),secondary:e,icon:r}}};xa.styles=r`
    :host {
      display: flex;
  ...
  `,t([ce({attribute:!1})],xa.prototype,"hass",void 0),t([ce()],xa.prototype,"domain",void 0),t([ce()],xa.prototype,"config",void 0),t([ce({type:Array})],xa.prototype,"value",void 0),t([ce({type:Boolean})],xa.prototype,"multiple",void 0),t([ce({type:Boolean})],xa.prototype,"disabled",void 0),t([ue()],xa.prototype,"multipleMode",void 0),t([ue()],xa.prototype,"scheduleEntities",void 0),xa=t([de("scheduler-entity-picker")],xa);let $a=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([ce()],ja.prototype,"disabled",void 0),t([ue()],ja.prototype,"_openedItem",void 0),t([ue()],ja.prototype,"_numItems",void 0),ja=t([de("scheduler-collapsible-group")],ja);const Oa="__NONE_OPTION__";let Sa=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Qs(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
        ...
        `)},l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",i.offsetWidth+"px"),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},u=e=>{const t=e.detail.item.value;(t!=Oa&&!Array.isArray(this.value)||(e.target.value=void 0,t!=Oa))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},h=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},m=nt(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,p=m?m.primary||m.id:nt(this.value)&&!Array.isArray(this.value)?this.value:void 0;return q`
        <div class="select-wrapper">
          ...
          >
            <ha-picker-field
              ...
              @clear=${h}
              .disabled=${this.disabled}
              .hideClearIcon=${this.disabled||!nt(this.value)||Array.isArray(this.value)&&!this.value.length}
              .value=${p}
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!nt(t.min)||!nt(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),nt(s)&&(s=ws(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=ws(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&nt(t.min)&&(s=Number(e)>=t.min),s&&nt(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return q`
      ...
      `}if(this.config.boolean){let e={select:{options:[{value:"true",label:"True",icon:"mdi:check"},{value:"false",label:"False",icon:"mdi:close"}]}};const t=e=>{let t=nt(e.detail.value)?"true"===e.detail.value:void 0;e.stopPropagation(),this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Qs(this,"value-changed",{value:this.value})}};Sa.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([ce({attribute:!1})],Sa.prototype,"hass",void 0),t([ce({attribute:!1})],Sa.prototype,"config",void 0),t([ce()],Sa.prototype,"value",void 0),t([ce({type:Boolean})],Sa.prototype,"disabled",void 0),Sa=t([de("scheduler-combo-selector")],Sa);let Ca=class extends oe{constructor(){super(...arguments),this._config={},this.title="",this.tagOptions=[],this.customTagValue=""}setConfig(e){this._config=Object.assign({},e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await ea(this.hass)).map(e=>e.name);e.sort(us),this.tagOptions=e}render(){var e,t,i,s,a,o,n,r,d;const l={number:{min:0,max:30,step:1,unit_of_measurement:ls("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},c={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">

        <ha-button @click=${this._showIncludedEntitiesDialog} outlined>
          ${ls("ui.panel.card_editor.fields.entities.button_label",this.hass)}
          <ha-svg-icon
            slot="trailingIcon"
        ...
        <scheduler-settings-row ?showPrefix=${!0}>
          ...
          <span slot="heading">${ls("ui.panel.card_editor.fields.title.heading",this.hass)}</span>

          <ha-input
            .value=${this.title}
            @input=${this._setTitle}
            .placeholder=${ls("ui.panel.common.title",this.hass)}
        ...
        <div class="column">
          <ha-formfield label="${ls("ui.panel.card_editor.fields.discover_existing.heading",this.hass)}">
            <ha-switch
        ...
        <div class="column">
          <ha-formfield label="${ls("ui.panel.card_editor.fields.show_header_toggle.heading",this.hass)}">
            <ha-switch
        ...
        <div class="column">
          <ha-formfield label="${ls("ui.panel.card_editor.fields.show_toggle_switches.heading",this.hass)}">
            <ha-switch
        ...
        <scheduler-settings-row>
          <span slot="heading">${ls("ui.panel.card_editor.fields.time_step.heading",this.hass)}</span>
        ...
        <span>${ls("ui.panel.card_editor.fields.default_editor.heading",this.hass)}</span>
        <div class="two-columns">
          <div class="column radio"
            @click=${()=>{this._updateConfig({default_editor:pe.Single})}}
          >
            <ha-icon
              icon="${this._config.default_editor!=pe.Scheme?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${this._config.default_editor!=pe.Scheme?"checked":""}"
            ></ha-icon>
            <span>${ls("ui.panel.card_editor.fields.default_editor.options.single",this.hass)}</span>
          </div>
          <div class="column radio"
            @click=${()=>{this._updateConfig({default_editor:pe.Scheme})}}
          >
            <ha-icon
              icon="${this._config.default_editor==pe.Scheme?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${this._config.default_editor==pe.Scheme?"checked":""}"
            ></ha-icon>
            <span>${ls("ui.panel.card_editor.fields.default_editor.options.scheme",this.hass)}</span>
          </div>
        </div>

          <span slot="heading">${ls("ui.panel.card_editor.fields.sort_by.heading",this.hass)}</span>
        ...
        <div class="two-columns">
          ...
          >
            <ha-icon
              icon="${[this._config.sort_by||xe].flat().includes("relative-time")?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${[this._config.sort_by||xe].flat().includes("relative-time")?"checked":""}"
            ></ha-icon>
            <span>${ls("ui.panel.card_editor.fields.sort_by.options.relative_time",this.hass)}</span>
          </div>
          <div class="column radio"
            @click=${()=>{this._setSortBy("title")}}
          >
            <ha-icon
              icon="${[this._config.sort_by||xe].flat().includes("title")?"mdi:radiobox-marked":"mdi:radiobox-blank"}"
              class="${[this._config.sort_by||xe].flat().includes("title")?"checked":""}"
            ></ha-icon>
            <span>${ls("ui.panel.card_editor.fields.sort_by.options.title",this.hass)}</span>
          </div>
        </div>

        <span>${ls("ui.panel.card_editor.fields.display_format_primary.heading",this.hass)}</span>
        ...
        <div class="two-columns">
          ...
          >
            ...
            ></ha-icon>
            <span>${ls("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}</span>
          </div>
          <div class="column radio"
          ...
          >
            ...
            ></ha-icon>
            <span>${ls("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}</span>
          </div>
        </div>
        <span>${ls("ui.panel.card_editor.fields.display_format_secondary.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">
          <ha-formfield label="${ls("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              value="relative-time"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(a=this._config.display_options)||void 0===a?void 0:a.secondary_info)||$e].flat().includes("relative-time")}
            >
            </ha-checkbox>
          </ha-formfield>

          <ha-formfield label="${ls("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(o=this._config.display_options)||void 0===o?void 0:o.secondary_info)||$e].flat().includes("time")}
            >
            </ha-checkbox>
          </ha-formfield>
        ...
        <div class="column">
          <ha-formfield label="${ls("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(n=this._config.display_options)||void 0===n?void 0:n.secondary_info)||$e].flat().includes("days")}
            >
            </ha-checkbox>
          </ha-formfield>

          <ha-formfield label="${ls("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
              value="additional-tasks"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(r=this._config.display_options)||void 0===r?void 0:r.secondary_info)||$e].flat().includes("additional-tasks")}
            >
            </ha-checkbox>
          </ha-formfield>

          <ha-formfield label="${ls("ui.panel.card_editor.fields.display_format_secondary.options.conditions",this.hass)}">
            <ha-checkbox
              value="conditions"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(d=this._config.display_options)||void 0===d?void 0:d.secondary_info)||$e].flat().includes("conditions")}
            >
            </ha-checkbox>
          </ha-formfield>
        </div>
        ...
        <scheduler-settings-row>
          <span slot="heading">${ls("ui.panel.card_editor.fields.tags.heading",this.hass)}</span>
  ...
  `,t([ce({attribute:!1})],Ca.prototype,"hass",void 0),t([ce()],Ca.prototype,"_config",void 0),t([ce()],Ca.prototype,"title",void 0),t([ce()],Ca.prototype,"tagOptions",void 0),t([ue()],Ca.prototype,"customTagValue",void 0),Ca=t([de("scheduler-card-editor")],Ca);const za=r`
  ha-dialog {
...
`,(e,t,i,s)=>{const a=e.service,o=Re(i,e),n=bs(e,s);if(!n||!n.fields||!Object.keys(n.fields).includes(t))return!1;const r=n.fields[t];if(null===js(a,o,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(r.supported_features){if(![o||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&r.supported_features)>0}))return!1}return!("light"==Ae(a)&&![o||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||s.filter(e=>"onoff"!=e).length}))});var Ea;!function(e){e.OverlappingTime="overlapping_time",e.MissingTarget="missing_target",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(Ea||(Ea={}));const Ta=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Ye(i.start,t),o=void 0===i.stop?a:Ye(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Ye(e.start,t)>=o})})?null:Ea.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,Ea.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{const s=bs(e,i);return(null==s?void 0:s.target)&&Le(e.target)?Ea.MissingTarget:(null==s?void 0:s.fields)&&!Object.entries(s.fields).filter(([s])=>Aa(e,s,t,i)).every(([s,a])=>{var o;let n=js(e.service,Re(t,e),s,t,i);const r=!(!n.number||!(null===(o=n.number)||void 0===o?void 0:o.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!r)&&!(!nt(e.service_data[s])&&!r)})?Ea.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},Da=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(Ma),timeslots:e.entries[0].slots.map(La),name:e.name?e.name.trim():e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},Ma=e=>{switch(e){case ge.Monday:return"mon";case ge.Tuesday:return"tue";case ge.Wednesday:return"wed";case ge.Thursday:return"thu";case ge.Friday:return"fri";case ge.Saturday:return"sat";case ge.Sunday:return"sun";case ge.Workday:return"workday";case ge.Weekend:return"weekend";default:return"daily"}},La=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>Pa(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ve.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),Pa=e=>{const t=e=>Object.keys(e).filter(t=>nt(e[t])).reduce((t,i)=>(t[i]=e[i],t),{}),i=Me(e.target);if(!i){return{service:e.service,service_data:t(e.service_data)}}let s={service:e.service,service_data:t(e.service_data),target:i};return Pe(i)&&e.target_filter&&(s=Object.assign(Object.assign({},s),{target_filter:e.target_filter})),s},Na=(e,t,i)=>{const s={title:ms("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:ms("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Qs(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return _o})),dialogParams:s})},Ia=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},qa=(e,t)=>{const i=bs(e,t),s=Ae(e.service),a=ze(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys($s).includes(s)&&Object.keys($s[s].services).includes(a)){if(void 0!==$s[s].attributes){let t=$s[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return $s[s].services[a]}return Object.keys($s).includes(s)&&Object.keys($s[s].services).includes("{entity_id}")?$s[s].services["{entity_id}"]:"mdi:flash";var o},Ra=(e,t,i)=>{let s=Ye("string"==typeof e?Ge(e):e,i),a=Ye("string"==typeof t?Ge(t):t,i);return a>s?1:a<s?-1:0},Va=e=>Ge(e.start),Ha=e=>{if(nt(e.stop)){const t=Ge(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==ke.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Ke(Va(e),{minutes:1})},Fa=(e,t,i,s)=>{let a=t;if(nt(i.stop))return[e,a]=Fa(e,t+1,{start:i.stop},s),[e,a-1];if(!nt(i.start))return[e,a];let o=Va(e[t]),n=i.start,r=Va(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?Ke(Va(e[i]),{minutes:1}):Ha(e[i]);break}r=Va(e[i])}let d=Ke(Ha(e[t]),{minutes:-1});if(!nt(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?Ke(Ha(e[i]),{minutes:-1}):Va(e[i]);break}d=Ha(e[i])}if(Ra(r,n,s)<0&&(n=r),Ra(d,n,s)>0&&Ye(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:at(n)})}),Ra(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=Ra(Va(e[i]),n,s),o=Ra(Ha(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:at(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(Ra(o,n,s)<0&&!nt(e[t].stop)&&(e=nt(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:at(Ha(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:at(Ha(e[t])),stop:at(Va(e[t+1])),actions:[]}),...e.slice(t+1)]),Ra(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=Ha(e[a]),o=Ra(Va(e[t]),i,s),n=Ra(Ha(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:at(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return Ra(o,n,s)>0&&(t>0&&nt(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:at(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?at(Ha(e[t-1])):"00:00:00",stop:at(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(nt),a]},Ua=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Je({hours:n,minutes:r})};let Ba=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this.large=!1}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e)}}),this._resizeObserver.observe(this)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect()}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=this._width,t=[1,2,3,4,6,8,12],i=et(this.hass.locale),s=i?130:100;if(!e)return q``;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:ke.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${ma({width:s/2+"%"})}>${at(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${ma({width:s/2+"%"})}>${at(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${ma({width:s+"%"})}>${at(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?Ds(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${ma({width:t[s]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?q`<span style="margin-left: ${n}px; margin-right: ${r}px">${a}</span>`:d>16?q`<ha-icon icon="${qa(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
        ...
        `:""}
      `})}computeSlotWidths(){const e=this._width,t=this.schedule.slots,i=e-3*(t.length-1),s=t.map((e,i)=>{const s=Ye(e.start,this.hass);let a;if(void 0!==e.stop)a=Ye(e.stop,this.hass),!a&&s&&(a=86400);else{const e=t[i+1];a=e&&Ye(e.start,this.hass)||86400}return(a-s)/86400}),a=5/i,o=i-5*s.filter(e=>e<a).length;return s.map(e=>e<a?5:e*o)}_toggleSelectTimeslot(e){let t=e.target;"div"!=t.tagName.toLowerCase()&&(t=t.parentElement);const i=Number(t.getAttribute("idx"));this.selectedSlot=this.selectedSlot!==i?i:null;const s=new CustomEvent("update",{detail:{selectedSlot:this.selectedSlot}});this.dispatchEvent(s),e.stopPropagation()}_handleDragStart(e){e.preventDefault(),e.stopPropagation();let t=e.target;for(;"DIV"!==t.tagName;)t=t.parentElement;const i=t.parentElement.getBoundingClientRect(),s=Number(t.getAttribute("idx")),a=this.config.time_step||15,o=60*a;let n=s>0?Ye(this.schedule.slots[s-1].stop||this.schedule.slots[s-1].start,this.hass)+o:o,r=(Ye(this.schedule.slots[s+1].stop||this.schedule.slots[s+1].start,this.hass)||86400)-o;void 0===this.schedule.slots[s+1].stop&&(r=(Ye(this.schedule.slots[s+2].stop||this.schedule.slots[s+2].start,this.hass)||86400)-o);const d=Ge(this.schedule.slots[s+1].start).mode;if([ke.Sunrise,ke.Sunset].includes(d)){let e=Ge(this.schedule.slots[s+1].start),t=Ye(Object.assign(Object.assign({},e),{hours:4,minutes:0}),this.hass),i=Ye(Object.assign(Object.assign({},e),{hours:-4,minutes:0}),this.hass);i>n&&(n=i),t<r&&(r=t)}let l=e=>{let t;e.preventDefault(),t="undefined"!=typeof TouchEvent&&e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX,t-=i.left,t>i.width&&(t=i.width),t<0&&(t=0);let o=Math.round(t/i.width*86400);o<n?o=n:o>r&&(o=r);const l=Math.floor(o/3600),c=Math.round((o-3600*l)/60);let u={mode:ke.Fixed,hours:l,minutes:c};if([ke.Sunrise,ke.Sunset].includes(d)){const e=d==ke.Sunrise?this.hass.states["sun.sun"].attributes.next_rising:this.hass.states["sun.sun"].attributes.next_setting,t=Ua(u,e);u={mode:d,hours:t.hours,minutes:t.minutes}}u=Je(u,a);const h=at(u);let m=[...this.schedule.slots];if(m=Object.assign(m,{[s]:Object.assign(Object.assign({},m[s]),{stop:h}),[s+1]:Object.assign(Object.assign({},m[s+1]),{start:at(u)})}),void 0===m[s+1].stop){const e=at(Ke(u,{minutes:1}));m=Object.assign(m,{[s+2]:Object.assign(Object.assign({},m[s+2]),{start:e})})}this.schedule=Object.assign(Object.assign({},this.schedule),{slots:m});const p=new CustomEvent("update",{detail:{slots:m}});this.dispatchEvent(p)};const c=e=>{e.preventDefault()},u=()=>{window.removeEventListener("mousemove",l),window.removeEventListener("touchmove",l),window.removeEventListener("mouseup",u),window.removeEventListener("touchend",u),window.removeEventListener("blur",u),window.removeEventListener("dragstart",c),l=()=>{}};window.addEventListener("mouseup",u),window.addEventListener("touchend",u),window.addEventListener("blur",u),window.addEventListener("dragstart",c),window.addEventListener("mousemove",l),window.addEventListener("touchmove",l)}static get styles(){return r`
      :host {
        display: block;
        max-width: 100%;
        overflow: hidden;
    ...
    `}};t([ce({attribute:!1})],Ba.prototype,"config",void 0),t([ue()],Ba.prototype,"schedule",void 0),t([ue()],Ba.prototype,"selectedSlot",void 0),t([ue()],Ba.prototype,"_width",void 0),t([ce({type:Boolean})],Ba.prototype,"large",void 0),Ba=t([de("scheduler-timeslot-editor")],Ba);const Wa=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let Za=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=ke.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ge(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
        ...
        <div class="input">
          ...
          <div class="hours">
            ...
            <ha-button
              ...
              ?disabled=${this.mode!=ke.Fixed&&4==this.hours}
            >
            ...
            <ha-input
              ...
              min=${this.mode==ke.Fixed||this.large?0:-4}
              .disabled=${this.disabled}
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=ke.Fixed&&(e=Wa(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
          ${this.hass.states["sun.sun"]?q`
          <ha-button
            appearance="${this.mode==ke.Fixed?"plain":"accent"}"
            variant="${this.mode==ke.Fixed?"neutral":"brand"}"
            @click=${e}
          >
      ...
      `}{let e=[ke.Fixed,ke.Sunrise,ke.Sunset];const t={[ke.Fixed]:ms("ui.components.selectors.selector.types.time",this.hass),[ke.Sunrise]:ms("ui.panel.config.automation.editor.triggers.type.sun.sunrise",this.hass),[ke.Sunset]:ms("ui.panel.config.automation.editor.triggers.type.sun.sunset",this.hass)},i={[ke.Fixed]:"mdi:clock-outline",[ke.Sunrise]:"mdi:weather-sunset-up",[ke.Sunset]:"mdi:weather-sunset-down"},s={[ke.Fixed]:"M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z",[ke.Sunrise]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,16.3L15.82,19.41C16.21,19.8 16.21,20.43 15.82,20.82C15.43,21.21 14.8,21.21 14.41,20.82L12,18.41L9.59,20.82C9.2,21.21 8.57,21.21 8.18,20.82C7.79,20.43 7.79,19.8 8.18,19.41L11.29,16.3C11.5,16.1 11.74,16 12,16C12.26,16 12.5,16.1 12.71,16.3Z",[ke.Sunset]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,20.71L15.82,17.6C16.21,17.21 16.21,16.57 15.82,16.18C15.43,15.79 14.8,15.79 14.41,16.18L12,18.59L9.59,16.18C9.2,15.79 8.57,15.79 8.18,16.18C7.79,16.57 7.79,17.21 8.18,17.6L11.29,20.71C11.5,20.9 11.74,21 12,21C12.26,21 12.5,20.9 12.71,20.71Z"},a=e=>{if(e==ke.Fixed)return!1;const t=this._convertTimeMode(e);return Math.abs(60*t.hours+t.minutes)>240};return q`
      <ha-dropdown
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=it(this.hours).am_pm;const t=it(this.hours).hours;this.hours=st(t,"AM"==e?tt.PM:tt.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==ke.Sunrise?ke.Sunset:ke.Sunrise,this._valueChanged()};return q`
        <div class="suffix">
        ${this.useAmPm&&this.mode==ke.Fixed?q`
            <ha-button appearance="plain" @click=${e}>
              <span class="large">
                ${it(this.hours).am_pm==tt.AM?"AM":"PM"}
              </span>
            </ha-button>
          `:V}
        ${this.mode!=ke.Fixed?q`
            ...
            <ha-button appearance="plain" @click=${i}>
              <ha-icon icon="${this.mode==ke.Sunrise?"mdi:weather-sunny":"mdi:weather-night"}"></ha-icon>
            </ha-button>
         `:V}
        </div>
      `}return this.useAmPm&&this.mode==ke.Fixed?q`
        <ha-select
          .required=${this.required}
          .value=${it(this.hours).am_pm==tt.AM?"AM":"PM"}
          .disabled=${this.disabled}
          name="amPm"
          naturalMenuWidth
          fixedMenuPosition
      ...
      `:V}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=ke.Fixed||this.mode==ke.Fixed){const s=Ua({hours:this.hours,minutes:this.minutes},t),a=Ua({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?ke.Sunrise:ke.Sunset),d=r==ke.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==ke.Sunrise?Ge(t):Ge(i);return e=Ke(e,{hours:this.hours,minutes:this.minutes}),{mode:ke.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=it(this.hours).am_pm;t=st(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.detail.value;if(it(this.hours).am_pm==t)return;const i=it(this.hours).hours;this.hours=st(i,"AM"==t?tt.AM:tt.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ke(t,e),e.minutes&&(t=Je(t,this.stepSize)),this.mode!=ke.Fixed&&(t=Wa(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};Qs(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==ke.Fixed?it(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==ke.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};Za.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([ce({attribute:!1})],Za.prototype,"hass",void 0),t([ue()],Za.prototype,"hours",void 0),t([ue()],Za.prototype,"minutes",void 0),t([ue()],Za.prototype,"mode",void 0),t([ce({type:Boolean})],Za.prototype,"autoValidate",void 0),t([ce({type:Boolean})],Za.prototype,"required",void 0),t([ce({type:Boolean})],Za.prototype,"disabled",void 0),t([ce({type:String})],Za.prototype,"label",void 0),t([ce({type:Boolean})],Za.prototype,"useAmPm",void 0),t([ce({type:Boolean})],Za.prototype,"large",void 0),t([ce({attribute:!1})],Za.prototype,"stepSize",void 0),Za=t([de("scheduler-time-picker")],Za);let Ka=class extends oe{constructor(){super(...arguments),this.disabled=!1,this._resolvedCount=null,this._mode="loading",this._resolveJob=0,this._entityFilter=e=>(!this.domain||e.entity_id.split(".").shift()==this.domain)&&(!(this.cardConfig&&!De(e.entity_id,this.cardConfig))&&!(this.filterFunc&&!this.filterFunc(e))),this._deviceFilter=e=>{const t=this.hass.entities||{};return Object.values(t).some(t=>t.device_id==e.id&&!t.disabled_by&&!t.hidden_by&&!t.entity_category&&(!this.domain||t.entity_id.split(".").shift()==this.domain)&&(!this.cardConfig||De(t.entity_id,this.cardConfig))&&(!this.filterFunc||!this.hass.states[t.entity_id]||this.filterFunc(this.hass.states[t.entity_id])))}}async firstUpdated(){try{await re()}catch(e){}this._computeMode(),"selector"==this._mode&&customElements.whenDefined("ha-target-picker").then(()=>{this._computeMode()}),this._updateResolvedCount()}_computeMode(){customElements.get("ha-target-picker")?this._mode="native":customElements.get("ha-selector")?this._mode="selector":this._mode="unavailable"}updated(e){super.updated(e),(e.has("value")||e.has("domain"))&&this._updateResolvedCount()}async _updateResolvedCount(){const e=Me(this.value);if(!e||!Pe(e))return void(this._resolvedCount=null);const t=++this._resolveJob,i=this._targetFilter;let s;try{s=await((e,t,i,s)=>e.callWS(Object.assign(Object.assign({type:"scheduler/resolve_target",target:Me(t)||{}},i?{domain:i}:{}),s?{target_filter:s}:{})).then(e=>e.entities))(this.hass,e,this.domain,i)}catch(t){s=qe(this.hass,e,this.domain,i)}t==this._resolveJob&&(this._resolvedCount=s.length)}render(){return this.hass&&"loading"!=this._mode?"unavailable"==this._mode?q`
        <ha-alert alert-type="warning">
          ${ls("ui.components.target.picker_unavailable",this.hass)}
        </ha-alert>
      `:q`
      <div class="picker">
        ${"native"==this._mode?q`
          ...
          <ha-selector
            ...
            @value-changed=${this._valueChanged}
          ></ha-selector>`}
        ${null!==this._resolvedCount?q`
          <div class="summary">
            <ha-icon icon="${this._resolvedCount?"mdi:information-outline":"mdi:alert-outline"}"></ha-icon>
            ${ls(1==this._resolvedCount?"ui.components.target.resolved_entities_single":"ui.components.target.resolved_entities",this.hass,"{number}",String(this._resolvedCount))}
          </div>`:""}
      </div>
    `:q``}get _targetFilter(){return Ie(this.cardConfig)}get _targetSelector(){if(!this.domain)return{target:{}};let e={domain:[this.domain]};return this.supportedFeatures&&(e=Object.assign(Object.assign({},e),{supported_features:[this.supportedFeatures]})),{target:{entity:[e]}}}_valueChanged(e){e.stopPropagation();const t=Me(e.detail.value);this.value=t||{},Qs(this,"value-changed",{value:Le(t)?void 0:t})}};Ka.styles=r`
    :host {
      display: block;
    }
    .summary {
  ...
  `,t([ce({attribute:!1})],Ka.prototype,"hass",void 0),t([ce({type:Object})],Ka.prototype,"value",void 0),t([ce({attribute:!1})],Ka.prototype,"cardConfig",void 0),t([ce()],Ka.prototype,"domain",void 0),t([ce({type:Number})],Ka.prototype,"supportedFeatures",void 0),t([ce({type:Boolean})],Ka.prototype,"disabled",void 0),t([ue()],Ka.prototype,"_resolvedCount",void 0),t([ue()],Ka.prototype,"_mode",void 0),Ka=t([de("scheduler-target-picker")],Ka);let Ja=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
      >
        <ha-dialog-header slot="header">
          ...
          `};
          <div slot="title">
              ${ls("ui.dialog.weekday_picker.title",this.hass)}
          </div>
        </ha-dialog-header>
        <div class="wrapper">
          <ha-list>
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[ge.Sunday,ge.Monday,ge.Tuesday,ge.Wednesday,ge.Thursday,ge.Friday,ge.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Ns(this.hass))}else e=[ge.Daily,ge.Workday,ge.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.some(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <ha-list-item
          graphic="icon"
    ...
    `}};t([ce({attribute:!1})],Ja.prototype,"hass",void 0),t([ue()],Ja.prototype,"_params",void 0),t([ue()],Ja.prototype,"weekdayTypeCustomSelected",void 0),t([ue()],Ja.prototype,"selectedWeekdays",void 0),Ja=t([de("dialog-select-weekdays")],Ja);var Ga=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return Ja}});const Ya=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),Qa=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(_s).includes(t))return!1;let s=Object.keys(_s[t]).includes(e);if(!s&&Object.keys(_s[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=De(`${t}.${e}`,i)}return s}):[],a=t=>ms(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{let o=hs(Ds({service:`${t}.${s}`,service_data:{}},e,i.customize));return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&nt(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:`${hs(Rs(`${t}.${s}`,e,i.customize))}: ${o}`:`${a(t)}: ${o}`},n=i=>{let s=ms(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=ms(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&nt(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys($s).includes(t)&&Object.keys($s[t].services).includes(a)?$s[t].services[a]:ra(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),d=(l=i.customize||{},c=t,Object.keys(l).filter(e=>{var t;return null===(t=l[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Te(Ae(e),c)||Te(e,c)).map(e=>l[e].exclude_actions).flat().filter(nt));var l,c;return d.length&&(r=r.filter(t=>!d.some(s=>Ya(ze(t.action.service),s)>0||Ya(Ds(t.action,e,i.customize),s)>0))),fs(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=Cs(i),a=Ia(s);!nt(e.service_data[t])&&nt(a)?e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}):nt(e.service_data[t])||(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:null})}))}),r.push({key:i,name:`${a(t)}: ${Xa(e.name||o(ze(e.service)))}`,description:Xa(e.name||""),icon:e.icon||ra(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Xa=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let eo=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1,this.showAll=!1}async showDialog(e){this._params=e,this.lockDomain=void 0!==e.domainFilter,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
      >
        <div slot="header">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${ms("ui.common.back",this.hass)}
              .path=${ia}
              @click=${this._clearDomain}
            ></ha-icon-button>
            `}
            <div slot="title">
              ${ls("ui.dialog.action_picker.title",this.hass)}
            </div>
            ${!this.lockDomain&&nt(this._params.cardConfig.include)?q`
            <ha-dropdown
              placement="bottom-end"
              slot="actionItems"
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .label=${this.hass.localize("ui.common.menu")} .path=${aa}>
              </ha-icon-button>
              <ha-dropdown-item @click=${this._toggleShowAll}>
                ...
                ></ha-icon>
                ${ls("ui.dialog.action_picker.show_all",this.hass)}
              </ha-dropdown-item>
            </ha-dropdown>`:""}
          </ha-dialog-header>
    ...
    `}};t([ce({attribute:!1})],eo.prototype,"hass",void 0),t([ue()],eo.prototype,"_params",void 0),t([ue()],eo.prototype,"_search",void 0),t([ue()],eo.prototype,"_filter",void 0),t([ue()],eo.prototype,"_width",void 0),t([ue()],eo.prototype,"_height",void 0),t([ue()],eo.prototype,"lockDomain",void 0),t([ue()],eo.prototype,"showAll",void 0),eo=t([de("dialog-select-action")],eo);var to=Object.freeze({__proto__:null,get DialogSelectAction(){return eo}});let io=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([ce({type:Boolean})],io.prototype,"showPrefix",void 0),io=t([de("scheduler-settings-row")],io);const so=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return!isNaN(e)&&(!(void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min)&&!(void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&e>t.number.max))})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,ao=e=>null==e||Array.isArray(e)?e:[e];let oo=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.showAll=!1}async showDialog(e){this._params=e,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
      >
        <div slot="header">
          <ha-dialog-header>
            ...
            ></ha-icon-button>
            <div slot="title">
              ${ls("ui.panel.options.conditions.add_condition",this.hass)}
            </div>
            ${nt(this._params.domain)?"":q`
            <ha-dropdown
              placement="bottom-end"
              slot="actionItems"
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
    ...
    `}};t([ce({attribute:!1})],oo.prototype,"hass",void 0),t([ue()],oo.prototype,"_params",void 0),t([ue()],oo.prototype,"_search",void 0),t([ue()],oo.prototype,"_filter",void 0),t([ue()],oo.prototype,"_width",void 0),t([ue()],oo.prototype,"_height",void 0),t([ue()],oo.prototype,"showAll",void 0),oo=t([de("dialog-select-condition")],oo);var no=Object.freeze({__proto__:null,get DialogSelectCondition(){return oo}});let ro=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0}async firstUpdated(){(await window.loadCardHelpers()).importMoreInfoControl("input_datetime")}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
      <div class="header first">
        <span>${ls("ui.panel.options.conditions.header",this.hass)}:</span>
        ${this.schedule.entries[0].slots[0].conditions.items.length?q`
        <div class="condition-config">
          <span class="condition-mode">
            ${ls(this.schedule.entries[0].slots[0].conditions.type==ve.And?"ui.panel.options.conditions.options.logic_and_short":"ui.panel.options.conditions.options.logic_or_short",this.hass)}${this.schedule.entries[0].slots[0].conditions.track_changes?q`, ${ls("ui.panel.options.conditions.options.track_changes_short",this.hass)}`:""}
          </span>
          <ha-dropdown
          ...
          >
            <ha-icon
              icon="mdi:check"
              style="${this.schedule.entries[0].slots[0].conditions.type==ve.Or?"":"visibility: hidden"}"
            ></ha-icon>
            ${ls("ui.panel.options.conditions.options.logic_or",this.hass)}
          </ha-dropdown-item>
          <ha-dropdown-item
            ?disabled=${this.schedule.entries[0].slots[0].conditions.items.length<2}
            value="and"
          >
            <ha-icon
              icon="mdi:check"
              style="${this.schedule.entries[0].slots[0].conditions.type==ve.And?"":"visibility: hidden"}"
            ></ha-icon>
            ${ls("ui.panel.options.conditions.options.logic_and",this.hass)}
          </ha-dropdown-item>
          <ha-dropdown-item value="track_changes">
            ...
            ></ha-icon>
            ${ls("ui.panel.options.conditions.options.track_changes",this.hass)}
          </ha-dropdown-item>
          </ha-dropdown>
        </div>
        `:""}
      ...
      <scheduler-collapsible-section idx="${t}">
        ...
        >
          ...
          <ha-dropdown-item value="change_type">
            ...
            ${ms("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
          </ha-dropdown-item>
          <ha-dropdown-item variant="danger" value="delete">
            <ha-icon icon="mdi:delete"></ha-icon>
            ${ms("ui.common.delete",this.hass)}
          </ha-dropdown-item>
        </ha-dropdown>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${ms("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            ...
            .value=${this.conditionIdx==t?ao(this.selectedEntity):ao(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${hs(ls(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-dropdown
              @wa-select=${this._selectMatchType}
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .path=${"M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z"}>
              </ha-icon-button>
              ${n.map(i=>q`
                <ha-dropdown-item 
                ...
                >
                  ...
                  ${hs(ls(d[i],this.hass,["{entity}","{value}"],["",""]))}
                </ha-dropdown-item>
              `)}
            </ha-dropdown>
          </span>
    ...
    `}};t([ce({attribute:!1})],ro.prototype,"hass",void 0),t([ce({attribute:!1})],ro.prototype,"config",void 0),t([ue()],ro.prototype,"schedule",void 0),t([ue()],ro.prototype,"conditionIdx",void 0),t([ue()],ro.prototype,"selectedDomain",void 0),t([ue()],ro.prototype,"selectedEntity",void 0),t([ue()],ro.prototype,"selectedMatchType",void 0),t([ue()],ro.prototype,"conditionValue",void 0),t([ue()],ro.prototype,"conditionValid",void 0),ro=t([de("scheduler-conditions-editor")],ro);let lo=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.expandedAction=0,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
    <div class="name-row">
      <span>${ms("ui.common.name",this.hass)}:</span>
      <ha-input
        .value=${this.schedule.name||""}
        placeholder=${this.schedule.name?"":ms("ui.common.name",this.hass)}
    ...
    ${this.schedule.entries.map((e,t)=>q`
      ...
      <div class="editor-header">
        <div class="weekdays">
          <span>
            ${ls("ui.panel.editor.repeated_days",this.hass)}:
            ${qs(e.weekdays,"short",this.hass)}
          </span>
          <ha-icon-button .path=${"M19,3H18V1H16V3H8V1H6V3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H10V19H5V8H19V9H21V5A2,2 0 0,0 19,3M21.7,13.35L20.7,14.35L18.65,12.35L19.65,11.35C19.85,11.14 20.19,11.13 20.42,11.35L21.7,12.63C21.89,12.83 21.89,13.15 21.7,13.35M12,18.94L18.07,12.88L20.12,14.88L14.06,21H12V18.94Z"} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
        <div class="weekdays-actions">
        <ha-button appearance="plain" size="small" @click=${this.toggleViewMode}>
          ${this.viewMode==pe.Scheme?ls("ui.panel.editor.toggle_single_mode",this.hass):ls("ui.panel.editor.toggle_scheme_mode",this.hass)}
          <ha-icon slot="end" icon="mdi:swap-horizontal"></ha-icon>
        </ha-button>
        </div>
      </div>

      ${this.viewMode==pe.Scheme?q`
      <div class="editor-header">
        <div class="weekdays">
    ...
    `}toggleViewMode(){const e=this.viewMode==pe.Scheme?pe.Single:pe.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Ye(e,this.hass),s=(Ye(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${ia} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
    ...
    `}renderSlot(){if(null===this.selectedEntry||null===this.selectedSlot)return q`
        <div class="slot-placeholder"> 
          ${ls("ui.panel.editor.select_timeslot",this.hass)}
        </div>
      ...
      <div class="two-column">
        <div class="column">
          <scheduler-time-picker
            .hass=${this.hass}
            label="${ls("ui.panel.editor.start_time",this.hass)}:"
        ...
        <div class="column">
          <scheduler-time-picker
            .hass=${this.hass}
            label="${ls("ui.panel.editor.stop_time",this.hass)}:"
            ?disabled=${t}
            .time=${i}
      ...
      ${ls("ui.panel.editor.action",this.hass)}:
      ${e.actions.length>1?q`
        <scheduler-collapsible-group
          .openedItem=${this.expandedAction}
          @openclose-changed=${e=>{this.expandedAction=e.detail.item}}
        >
          ${e.actions.map((e,t)=>this._renderActionConfig(e,t,!0))}
        </scheduler-collapsible-group>`:e.actions.map((e,t)=>this._renderActionConfig(e,t,!1))}
      <div>
        <ha-button appearance="plain"
          @click=${e=>this._showActionDialog(e)}
        >
          <ha-icon slot="start" icon="mdi:plus"></ha-icon>
          ${ls("ui.panel.editor.add_action",this.hass)}
        </ha-button>
      </div>
    `}_renderActionConfig(e,t,i){var s,a;const o=bs(e,this.config.customize),n=(null===(s=o.target)||void 0===s?void 0:s.domain)||Ae(e.service),r=nt(null===(a=null==o?void 0:o.target)||void 0===a?void 0:a.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var i,s;return t<e.actions.length&&nt(null===(s=null===(i=bs(e.actions[t],this.config.customize))||void 0===i?void 0:i.target)||void 0===s?void 0:s.entity_id)});if(void 0===o)return q``;const d=Object.keys(o.fields||{}).filter(t=>Aa(e,t,this.hass,this.config.customize));let l="",c="";if(Pe(e.target))c=Ve(this.hass,e.target);else{let t=Ne(e.target);!t.length&&["notify","script"].includes(n)&&(t=[e.service]),c=t.map(e=>Rs(e,this.hass,this.config.customize)).join(", ")}return c.length&&(l+=c+": "),l+=Ds(e,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section
        idx="${t}"
        ?expanded=${!i}
        ?disabled=${!i}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${qa(e,this.config.customize)}"></ha-icon>
          <span>${hs(l)}</span>
        </div>

        <ha-dropdown
          slot="contextMenu" 
          @wa-select=${e=>this._actionItemOptionsClick(e,t)}
          @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
          placement="bottom-end"
        >
          <ha-icon-button slot="trigger" .path=${aa}>
          </ha-icon-button>
          <ha-dropdown-item value="change_type">
            <ha-icon icon="mdi:pencil"></ha-icon>
            ${ms("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
        ...
        <div slot="content">
          ...
          <scheduler-settings-row>
            ...
            <scheduler-target-picker
              ...
              .domain=${n}
              .supportedFeatures=${o.supported_features}
              .filterFunc=${e=>!o.supported_features||((e.attributes.supported_features||0)&o.supported_features)>0}
              @value-changed=${e=>this._selectTarget(t,e)}
              .value=${e.target||{}}
              ?disabled=${r}
            >
            </scheduler-target-picker>
            ...
            <scheduler-settings-row ?showPrefix=${a}>
              ${a?q`
                <ha-checkbox
                  slot="prefix"
                  ?checked=${n}
                  @change=${e=>this._toggleOptionalField(e,t,i,s)}
                >
                </ha-checkbox>
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{const a=Ae(e.service),o=ze(e.service);let n=ms(`component.${a}.services.${o}.fields.${t}.name`,i,!1);!n&&i.services[a]&&i.services[a][e.service]&&i.services[a][e.service].fields&&i.services[a][e.service].fields[t]&&(n=String(i.services[a][e.service].fields[t].name));const r=["script","notify"].includes(a)?[e.service]:Re(i,e),d=r.length?r[0]:e.service;let l=fs(s||{},d);if(l.length){let i=l.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(nt);if(i.length)return i[0]}return n||(n=t.replace(/_/g," ")),n})(e,i,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${s}
                ?disabled=${!n}
                .value=${Object.keys(e.service_data).includes(i)?e.service_data[i]:void 0}
                @value-changed=${e=>this._selectField(t,i,e)}
              >
              </scheduler-combo-selector>
            </scheduler-settings-row>
          `})}
    ...
    `}_updateAction(e,t,i=this.selectedSlot){const s=[...this.schedule.entries[this.selectedEntry].slots[i].actions];s[e]=t,this._updateSlot({actions:s},i)}_selectField(e,t,i){const s=i.detail.value,a=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]);let o=void 0!==s?Object.assign(Object.assign({},a.actions[e]),{service_data:Object.assign(Object.assign({},a.actions[e].service_data),{[t]:s})}):Object.assign(Object.assign({},a.actions[e]),{service_data:Object.fromEntries(Object.entries(a.actions[e].service_data).filter(([e])=>e!=t))});this._updateAction(e,o)}_toggleOptionalField(e,t,i,s){const a=e.target.checked,o=a?Ia(s):void 0;a?this._selectField(t,i,new CustomEvent("value-changed",{detail:{value:nt(o)?o:null}})):this._selectField(t,i,new CustomEvent("value-changed",{detail:{value:void 0}}))}_selectTarget(e,t){t.stopPropagation();const i=Me(t.detail.value),s=Pe(i)?Ie(this.config):void 0;this.schedule.entries[this.selectedEntry].slots.forEach((t,a)=>{if(e>=t.actions.length)return;let o=Object.assign(Object.assign({},t.actions[e]),{target:i||{},target_filter:s});this._updateAction(e,o,a)})}_handleUpdate(e,t){this.selectedEntry=t,e.detail.hasOwnProperty("selectedSlot")?(this._updateSelectedSlot(e.detail.selectedSlot),this.selectedSlot=e.detail.selectedSlot):e.detail.hasOwnProperty("slots")&&this._updateEntry({slots:e.detail.slots})}_updateName(e){e.stopPropagation();const t=e.target.value;this.schedule=Object.assign(Object.assign({},this.schedule),{name:null!=t?t:""})}_conditionsChanged(e){e.stopPropagation(),this.schedule=e.detail.schedule}_updateSelectedSlot(e){this.expandedAction=0,this.dispatchEvent(new CustomEvent("change",{detail:{selectedSlot:e}}))}_updateEntry(e){let t=Object.assign({},this.schedule.entries[this.selectedEntry]);t=Object.assign(Object.assign({},t),e),this.schedule=Object.assign(Object.assign({},this.schedule),{entries:Object.assign(this.schedule.entries,{[this.selectedEntry]:t})})}_updateSlot(e,t=this.selectedSlot){let i=Object.assign({},this.schedule.entries[this.selectedEntry].slots[t]);i=Object.assign(Object.assign({},i),e),this._updateEntry({slots:Object.assign(this.schedule.entries[this.selectedEntry].slots,{[t]:i})})}async _showWeekdayDialog(e,t){this.selectedEntry=t,await new Promise(i=>{const s={weekdays:[...this.schedule.entries[t].weekdays],cancel:()=>i(null),confirm:e=>i(e)};Qs(e.target,"show-dialog",{dialogTag:"dialog-select-weekdays",dialogImport:()=>Promise.resolve().then((function(){return Ga})),dialogParams:s})}).then(e=>{e&&this._updateEntry({weekdays:e})})}async _showActionDialog(e,t){let i=void 0,s=void 0;if(void 0!==t){const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].actions[t];if(e){const t=Ne(e.target);s=t.length?t:void 0,i=[...new Set([Ae(e.service),...t.map(Ae)])]}}await new Promise(t=>{const a={cancel:()=>t(null),confirm:e=>t(e),domainFilter:i,entityFilter:s,cardConfig:this.config};Qs(e.target,"show-dialog",{dialogTag:"dialog-select-action",dialogImport:()=>Promise.resolve().then((function(){return to})),dialogParams:a})}).then(e=>{if(!e)return;const i=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]);let s=Object.assign({},e);if(s.target){const e=Ae(s.service),t=this.schedule.entries[this.selectedEntry].slots.map(e=>e.actions).flat().find(t=>!Le(t.target)&&Ne(t.target).every(t=>Ae(t)==e));t&&(s=Object.assign(Object.assign({},s),{target:t.target,target_filter:t.target_filter}))}void 0!==t&&t<i.actions.length?this._updateAction(t,s):(this._updateSlot({actions:[...i.actions,s]}),this.expandedAction=i.actions.length)})}_actionItemOptionsClick(e,t){switch(e.detail.item.value){case"change_type":this._showActionDialog(e,t);break;case"delete":const i=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].actions.filter((e,i)=>i!==t);this._updateSlot({actions:i}),this.expandedAction>=i.length&&(this.expandedAction=Math.max(0,i.length-1))}}_stopTimeChanged(e){let t=e.detail.value,[i,s]=Fa([...this.schedule.entries[this.selectedEntry].slots],Number(this.selectedSlot),{stop:t},this.hass);this._updateEntry({slots:i}),s!=this.selectedSlot&&this._updateSelectedSlot(s)}_startTimeChanged(e){let t=e.detail.value,[i,s]=Fa([...this.schedule.entries[this.selectedEntry].slots],Number(this.selectedSlot),{start:t},this.hass);this._updateEntry({slots:i}),s!=this.selectedSlot&&this._updateSelectedSlot(s)}_addTimeslot(e){null!==this.selectedEntry&&null!==this.selectedSlot&&(this.schedule=((e,t,i,s)=>{let a=[...e.entries[t].slots],o=Ge(a[i].start),n=void 0===a[i].stop?o:Ge(a[i].stop);if(n.mode!==ke.Fixed||n.hours||n.minutes||(n=Object.assign(Object.assign({},n),{hours:24})),[ke.Sunrise,ke.Sunset].includes(o.mode)){const e=o.mode==ke.Sunrise?s.states["sun.sun"].attributes.next_rising:s.states["sun.sun"].attributes.next_setting;let t=Ge(e);o=Ke(t,{hours:o.hours,minutes:o.minutes})}const r=Ye(o,s),d=(Ye(n,s)-r)/2,l=Math.floor(d/3600),c=Math.round((d-3600*l)/60);let u=Ke(o,{hours:l,minutes:c});return u=Je(u,15),a=[...a.slice(0,i),Object.assign(Object.assign({},a[i]),{stop:at(u)}),Object.assign(Object.assign({},a[i]),{start:at(u),stop:at(n),actions:[]}),...a.slice(i+1)],e=Object.assign(Object.assign({},e),{entries:Object.assign(e.entries,{[t]:Object.assign(Object.assign({},e.entries[t]),{slots:a})})})})(this.schedule,this.selectedEntry,this.selectedSlot,this.hass),e.target.blur())}_removeTimeslot(e){null!==this.selectedEntry&&null!==this.selectedSlot&&(this.schedule=((e,t,i)=>{let s=[...e.entries[t].slots];const a=i==s.length-1?i-1:i;return s=[...s.slice(0,a),Object.assign(Object.assign({},s[a+1]),{start:s[a].start,stop:s[a+1].stop}),...s.slice(a+2)],e=Object.assign(Object.assign({},e),{entries:Object.assign(e.entries,{[t]:Object.assign(Object.assign({},e.entries[t]),{slots:s})})})})(this.schedule,this.selectedEntry,this.selectedSlot),this.selectedSlot>=this.schedule.entries[this.selectedEntry].slots.length&&(this.selectedSlot=this.schedule.entries[this.selectedEntry].slots.length-1),e.target.blur())}static get styles(){return r`
  :host {
    position: relative;
  }
  div.name-row {
  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
    ...
    `}};t([ce({attribute:!1})],lo.prototype,"hass",void 0),t([ce({attribute:!1})],lo.prototype,"config",void 0),t([ce({attribute:!1})],lo.prototype,"viewMode",void 0),t([ce({attribute:!1})],lo.prototype,"selectedSlot",void 0),t([ce({type:Boolean})],lo.prototype,"large",void 0),t([ue()],lo.prototype,"schedule",void 0),t([ue()],lo.prototype,"expandedAction",void 0),t([ue()],lo.prototype,"selectedEntry",void 0),lo=t([de("scheduler-main-panel")],lo);const co=["January","February","March","April","May","June","July","August","September","October","November","December"];function uo(e){return e.toISOString().split("T")[0]}function ho(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}let mo=class extends oe{constructor(){super(...arguments),this.startDate="",this.endDate="",this.tags=[],this.customTagValue=""}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||uo(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||uo(new Date);const i=(await ea(this.hass)).map(e=>e.name),s=[this.config.tags||[]].flat();this.tags=[...new Set([...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))])]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      <span class="header first">${ls("ui.panel.options.period.header",this.hass)}:</span>
      <div class="period">
        <div>
          <ha-checkbox
        ...
        <div>
          <span>${ls("ui.panel.options.period.start_date",this.hass)}</span>
        </div>
        <div class="input">
          <ha-date-input
            .locale=${this.hass.locale}
            value=${this.startDate}
            .label=${ms("ui.components.date-range-picker.start_date",this.hass)}
        ...
        <div>
          <span>${ls("ui.panel.options.period.end_date",this.hass)}</span>
        </div>
        <div class="input">
          <ha-date-input
            .locale=${this.hass.locale}
            value=${this.endDate}
            .label=${ms("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${ls("ui.panel.options.tags",this.hass)}:</span>
      <div>
        <scheduler-combo-selector
          .hass=${this.hass}
          .config=${e}
      ...
      <span class="header">${ls("ui.panel.options.repeat_type",this.hass)}:</span>
      <ha-button
        appearance="${this.schedule.repeat_type==we.Repeat?"filled":"plain"}"
        variant="${this.schedule.repeat_type==we.Repeat?"brand":"neutral"}"
        @click=${this.setRepeatType}
        value="${we.Repeat}"
      >
        <ha-icon slot="start" icon="mdi:refresh"></ha-icon>
        ${ms("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
        appearance="${this.schedule.repeat_type==we.Pause?"filled":"plain"}"
        variant="${this.schedule.repeat_type==we.Pause?"brand":"neutral"}"
        @click=${this.setRepeatType}
        value="${we.Pause}"
      >
        <ha-icon slot="start" icon="mdi:stop"></ha-icon>
        ${ms("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
        appearance="${this.schedule.repeat_type==we.Single?"filled":"plain"}"
        variant="${this.schedule.repeat_type==we.Single?"brand":"neutral"}"
        @click=${this.setRepeatType}
        value="${we.Single}"
      >
    ...
    `}};t([ce({attribute:!1})],mo.prototype,"hass",void 0),t([ce({attribute:!1})],mo.prototype,"config",void 0),t([ue()],mo.prototype,"schedule",void 0),t([ue()],mo.prototype,"startDate",void 0),t([ue()],mo.prototype,"endDate",void 0),t([ce()],mo.prototype,"tags",void 0),t([ue()],mo.prototype,"customTagValue",void 0),mo=t([de("scheduler-options-panel")],mo);let po=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
    ...
    `:q``}confirmClick(){this._params.confirm()}cancelClick(){this._params.cancel()}};t([ce({attribute:!1})],po.prototype,"hass",void 0),t([ue()],po.prototype,"_params",void 0),po=t([de("scheduler-generic-dialog")],po);var _o=Object.freeze({__proto__:null,get GenericDialog(){return po}});let go=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=null,this._panel="main",this._viewMode=pe.Single}set viewMode(e){if(this._viewMode=e,e==pe.Single){let e=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=e>=0?e:1}}shouldUpdate(e){return 1!=e.size||!e.has("hass")||!nt(this.hass)}async showDialog(e){var t;this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length&&nt(e.stop)).length>0||this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1||this.schedule.entries[this.selectedEntry].slots.length>3;let s=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=s>=0?s:null,this.viewMode=i?pe.Scheme:(null===(t=this._params)||void 0===t?void 0:t.cardConfig.default_editor)||pe.Single,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?q`
      <ha-dialog
        open
        @closed=${this.closeDialog}
      ...
      >
        <ha-dialog-header slot="header">
          ...
          <div slot="title" @click=${()=>this.large=!this.large}>
            ${this._params.editItem?this.schedule.name?null===(e=this.schedule)||void 0===e?void 0:e.name:ls("ui.panel.common.default_name",this.hass,"{id}",this._params.editItem):ls("ui.panel.common.new_schedule",this.hass)}
          </div>
        </ha-dialog-header>
        ...
        `}
          ...
          <div class="buttons" slot="footer">
            ...
            <ha-button appearance="plain" @click=${this._handleSaveClick}>
              ${ms("ui.common.save",this.hass)}
            </ha-button>
          </div>
      </ha-dialog>
    `:q``}_updateSchedule(e){if(!e.detail||"object"!=typeof e.detail)return;let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=Ta(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:ms("state_badge.default.error",this.hass),description:ls("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:ms("ui.common.ok",this.hass)};Qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return _o})),dialogParams:s})});else if(this.schedule.schedule_id){const t=ot(await Ys(this.hass,this.schedule.schedule_id),this.hass);if(me(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:ls("ui.dialog.enable_schedule.title",this.hass),description:ls("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:ms("ui.common.yes",this.hass),secondaryButtonLabel:ms("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return _o})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=Da(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>Na(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=Da(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>Na(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:ls("ui.dialog.confirm_delete.title",this.hass),description:ls("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:ms("ui.common.ok",this.hass),secondaryButtonLabel:ms("ui.common.cancel",this.hass)};Qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return _o})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>Na(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=pe.Scheme)if(t!=pe.Single||i)new Promise(t=>{const i={title:ls("ui.dialog.confirm_migrate.title",this.hass),description:ls("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return _o})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return e=[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:at(Ke(Ge(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.viewMode=t)});else{if(me([...this.schedule.entries],[...Se.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Ce.entries]});else{let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(nt)})})});this.schedule=ot(e,this.hass)}this.viewMode=t}else{this.viewMode=t;if(me([...this.schedule.entries],[...Ce.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Se.entries]});else{this.schedule.entries.some(e=>e.slots.some(e=>void 0===e.stop))&&(this.schedule=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map((e,t,i)=>{if(void 0!==e.stop)return e;const s=i[t+1];return Object.assign(Object.assign({},e),{stop:s?s.start:"00:00:00"})})}))}))}}}};go.styles=za,t([ce({attribute:!1})],go.prototype,"hass",void 0),t([ue()],go.prototype,"_params",void 0),t([ce({type:Boolean,reflect:!0})],go.prototype,"large",void 0),t([ue()],go.prototype,"schedule",void 0),t([ue()],go.prototype,"selectedEntry",void 0),t([ue()],go.prototype,"selectedSlot",void 0),t([ue()],go.prototype,"_panel",void 0),t([ue()],go.prototype,"_viewMode",void 0),go=t([de("dialog-scheduler-editor")],go);var vo=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return go}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class yo extends ha{constructor(e){if(super(e),this.et=V,e.type!==ca)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}yo.directiveName="unsafeHTML",yo.resultType=1;const fo=ua(yo);var bo=window&&window.__assign||function(){return(bo=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var wo={second:45,minute:45,hour:22,day:5};const ko=(e,t,i)=>{if(i===Xe.am_pm||!i&&t.time_format===Xe.am_pm){const t=it(e.getHours()).am_pm;return`${it(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Xe.twenty_four||!i&&t.time_format===Xe.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:et(t)}):et(t)?ko(e,t,Xe.am_pm):ko(e,t,Xe.twenty_four)};let xo=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return co[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=ls("ui.components.date.next_week_day",this._hass,"{weekday}",Ps(e,"long",this._hass)):1==s?a=ls("ui.components.date.tomorrow",this._hass):s>0&&(a=Ps(e,"long",this._hass));let o=ls("ui.components.time.absolute",this._hass,"{time}",ko(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=ls("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=ls("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ms("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ms("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=bo(bo({},wo),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${hs(this.relativeTime(this.datetime))}
    `}};t([ce()],xo.prototype,"_hass",void 0),t([ce()],xo.prototype,"datetime",void 0),xo=t([de("scheduler-relative-time")],xo);let $o=class extends oe{render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return q``;const a=["off","completed"].includes(s.state),o=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let n=qa(o,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=Re(this.hass,o).shift();["script","notify"].includes(Ae(o.service))&&(e=o.service),e&&(n=_a(e,this.config.customize,this.hass))}const r=!Ne(o.target).every(e=>Object.keys(this.hass.states).includes(e));return r&&(n="mdi:help"),q`
      <ha-icon
        icon="${n}"
      ...
      <div
        class="info ${a?"disabled":""} ${r?"defective":""}"
        @click=${this._handleItemClick}
      >
        ${this.renderDisplayItem((null===(t=this.config.display_options)||void 0===t?void 0:t.primary_info)||"default")}
        <div class="secondary">
        ${this.renderDisplayItem((null===(i=this.config.display_options)||void 0===i?void 0:i.secondary_info)||$e)}
        </div>
      </div>
      <div class="state">
        ${!1!==this.config.show_toggle_switches?q`<ha-switch
              ?checked=${["on","triggered"].includes(s.state||"")}
              ?disabled=${"completed"==s.state}
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return fo(e)};return Ks(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){const t=e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([ce()],$o.prototype,"hass",void 0),t([ce()],$o.prototype,"schedule_id",void 0),t([ce()],$o.prototype,"schedule",void 0),t([ce()],$o.prototype,"config",void 0),$o=t([de("scheduler-item-row")],$o),e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config={},this.showDiscovered=!1,this.translationsLoaded=!1,this.connectionError=!1}async setConfig(e){e=(e=>{let t=[];if(rt(e,"include")&&!ht(e.include)&&t.push("'include' must be a list of strings"),rt(e,"exclude")&&!ht(e.exclude)&&t.push("'exclude' must be a list of strings"),rt(e,"discover_existing")&&!dt(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!rt(e,"title")||dt(e.title)||ct(e.title)||t.push("'title' must be a boolean or string"),rt(e,"time_step")&&(!lt(e.time_step)||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),rt(e,"show_header_toggle")&&!dt(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),rt(e,"show_add_button")&&!dt(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),rt(e,"show_toggle_switches")&&!dt(e.show_toggle_switches)&&t.push("'show_toggle_switches' must be a boolean"),rt(e,"display_options")&&(ut(e.display_options)?(!rt(e.display_options,"primary_info")||ct(e.display_options.primary_info)||ht(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!rt(e.display_options,"secondary_info")||ct(e.display_options.secondary_info)||ht(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!rt(e.display_options,"icon")||ct(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!rt(e,"sort_by")||ct(e.sort_by)||ht(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),rt(e,"customize")&&!ut(e.customize))t.push("'customize' must be a struct");else if(rt(e,"customize")){let i=Object.entries(e.customize).map(([e,t])=>mt(e,t)).filter(nt);i.length&&t.push(...i)}if(!rt(e,"tags")||ct(e.tags)||ht(e.tags)||t.push("'tags' must be a string or list of strings"),!rt(e,"exclude_tags")||ct(e.tags)||ht(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign({},e)}async firstUpdated(){await re();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config"),await Xs(this.hass).then(e=>{e=Object.fromEntries(Object.entries(e).filter(([e])=>De(e,this._config))),this._config=Object.assign(Object.assign({},this._config),{customize:Object.assign(Object.assign({},e),this._config.customize||{})})})}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&ms("component.input_boolean.services.turn_on.name",this.hass,!1).length&&ms("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=[...this.schedules||[]],t=e.filter(e=>cs(e,this._config,this.hass)),i=e.filter(e=>!cs(e,this._config,this.hass));const s=this.showDiscovered?e.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")}):t.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${!nt(this._config.title)||"boolean"==typeof this._config.title&&this._config.title?ls("ui.panel.common.title",this.hass):"boolean"==typeof this._config.title?"":this._config.title}
          </div>
    ...
    ${this.connectionError?q`
        <div>
          <hui-warning .hass=${this.hass}>
            <span style="white-space: normal">
              ${ls("ui.panel.overview.backend_error",this.hass)}
            </span>
          </hui-warning>
        </div>
      `:Object.keys(e).length?t.map(e=>q`
          ...
          `):q`
        <div>
          ${ls("ui.panel.overview.no_entries",this.hass)}
        </div>
        `}
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?q`
          ...
          ${i.map(e=>q`
              ...
              <div>
                ...
                >
                  ${ls("ui.panel.overview.hide_excluded",this.hass)}
                </ha-button>
              </div>
            `:q`
              <div>
                ...
                >
                  +
                  ${ls("ui.panel.overview.excluded_items",this.hass,"{number}",Object.keys(e).length-t.length)}
                </ha-button>
              </div>
            `:""}
        </div>
        ...
        <div class="card-actions">
          ...
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${ms("ui.common.refresh",this.hass)}
          </ha-button>
            `:q`
          <ha-button appearance="plain" @click=${this._addClick}
            >${ms("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){Ze(this.hass).then(e=>{this.schedules=Gs(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>cs(e,this._config,this.hass)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Ys(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!cs(t,this._config,this.hass)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=Gs(a,this._config,this.hass)):a=Gs([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:ot(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};Qs(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return vo})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==pe.Scheme?JSON.parse(JSON.stringify(Se)):JSON.parse(JSON.stringify(Ce));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};Qs(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return vo})),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||cs(e,this._config,this.hass)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
